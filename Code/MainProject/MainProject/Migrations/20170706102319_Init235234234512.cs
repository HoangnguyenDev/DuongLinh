    ...
    public partial class Init235234234512 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookChappter", x => x.ID);
                    table.ForeignKey(
                        name: "FK_BookChappter_BookCategory_BookCategoryID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistoryofRedingBook", x => x.ID);
                    table.ForeignKey(
                        name: "FK_HistoryofRedingBook_AspNetUsers_ApplicationUserID",
                        column: x => x.ApplicationUserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_HistoryofRedingBook_BookChappter_BookChappterID",
                        column: x => x.BookChappterID,
                        principalTable: "BookChappter",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookChappter_BookCategoryID",
                table: "BookChappter",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HistoryofRedingBook_ApplicationUserID",
                table: "HistoryofRedingBook",
                column: "ApplicationUserID");

            migrationBuilder.CreateIndex(
                name: "IX_HistoryofRedingBook_BookChappterID",
                table: "HistoryofRedingBook",
                column: "BookChappterID");
